            ...
            <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                <div class="slider_text_box">
                    <div class="tp-caption tp-resizeme first_text"
                         ...
                         data-fontsize="['35','35','35','35','30','30']"
                         ...
                         data-textAlign="['left','left','left','left','left','center']">Sistem Informasi Manajemen
                        <br> Penanggulangan Kemiskinan (SiMapan)
                    ...
                    <div class="tp-caption tp-resizeme secand_text"
                         ...
                         data-textAlign="['left','left','left','left','left','center']">Kabupaten Situbondo
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme single_img"
                        ...
                        <img src="{{asset('website/img/situbondo.png')}}" alt="">
                    </div>
                </div>
            </li>
        </ul>
...
<section class="best_3d_area">
    <div class="left_3d">
        <div class="shap_slider_inner owl-carousel">
            <div class="item">
                ...
                <p>Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit am et tellus blandit.
                    Etiam
                    nec odio vestibul. Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit am
                    et
                    tellus.</p>
                <div class="media">
                    <img src="{{asset('website/img/team/people/people-5.jpg')}}" alt="">
    ...
    <div class="right_text">
        <div class="right_text_inner">
            <div class="text_3d">
                <div class="l_title">
                    <img src="{{asset('website/img/icon/title-icon.png')}}" alt="">
                ...
                <p>Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit am et tellus blandit.
                    ...
                    maximus dui, vel suscipit dolor. Donec elementum velit a orci facilisis rutrum. Nam convallis
                    vel
                    erat id dictum. Sed ut risus in orci convallis viverra a eget nisi. Aenean pellentesque elit
                    vitae
                    eros dignissim ultrices. </p>
            </div>
            <div class="shap_mobile">
                <img src="{{asset('website/img/iphone4.png')}}" alt="">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-6">
                <div class="team_people_text">
                    ...
                    <p>Cras ex mauris, ornare eget pretium sit amet, dignissim et turpis. Nunc nec maximus dui, vel
                        ...
                        dictum.
                        Sed ut risus in orci convallis viverra.</p>
                    <ul>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="{{asset('website/img/team/people/people-1.jpg')}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="{{asset('website/img/team/people/people-2.jpg')}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="{{asset('website/img/team/people/people-3.jpg')}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="{{asset('website/img/team/people/people-4.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="world_map_area p_100">
    <div class="container">
        <div class="world_map_inner">
            <img class="img-fluid" src="{{asset('website/img/world-map.png')}}" alt="">
...
<!--================Footer Area =================-->
<footer class="footr_area footer">
