...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">BERITA</h2>
            <ol class="breadcrumb">
        ...
        <div class="d-flex">
            <div class="justify-content-center">
                <a href="{{route('berita.create')}}" class="btn btn-primary my-2 btn-icon-text">
                    <i class="fe fe-plus-circle me-2"></i>  Tambah Berita</a>
            </div>
        </div>
    </div>
    <!-- End Page Header -->
    ...
    <div class="row sidemenu-height">
        <div class="col-lg-12">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-4">Tabel Berita</h6>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered border-bottom" id="berita">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p">penulis</th>
                                <th class="wd-25p">Konten</th>
